...
\begin{figure}
  ...
  \caption{
    Number of unsuccessful inspections approximated by the phrase-based model per phrase added.
    The approximation has a large spike upon addition of the phrase ``no skimmer''.
    Otherwise, individual phrases have little impact on the reported success rate.
  }
...
Second, inspectors often do not perform thorough skimmer inspections.
...
Criminals can buy pump security seals online \cite{}.
