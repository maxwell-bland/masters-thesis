...
\begin{table}
  ...
  \begin{tabular}{lcr}
    ...
    Random Sampling       & \numDocumentsSampled   &                          \\ \hline
  \end{tabular}
  \caption{The various skimmer detection success rates as reported by different methods for document analysis. TODO details}
...
This was done with a 95\% confidence level and 2\% confidence interval.
This approximated a skimmer detection success rate of \randomsamplesuccessrate
($\sigma = $\randomsamplestddev).
...
\begin{figure}
  ...
  \caption{
    Skimmer detection rates for 10 inspectors. TODO details
  }
...
[TODO Demonstrate examples of this, veriphone, seals, locks.
...
Figure~\ref{fig:insp-time-cdf} presents a CDF of the inspection times for \numInspectionTimesConfidence randomly sampled inspections.
...
Thus, a robust method of internal skimmer detection would have high impact.
...
We know from the reports internal skimmers are more common than external skimmers.
We also know that many are Bluetooth enabled.
