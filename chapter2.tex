...
\begin{quote}
  ...
  \end{quote}
    ...
    ``In addition to verifying accurate measurement, the Division reviews the equipment
      ...
      compliance \cite{}.''
    \url{https://agriculture.az.gov/weights-measures/inspection-results}
    ...
    character recognition on these documents. \footnote{The lesson being that analysis
      should be performed in the correct exploratory increments.}
    ...
    of pdftotext, I built a tool, code-named data-extract-PDF.
    %
    ...
    %
    For the final work \cite{}, we ended up getting ground truth data of skimmer detection
    ...
    \subsubsection{Skimmer word included}
    ...
    \subsubsection{Phrase-based analysis}
    ...
    research in the late 80's and early 90's \cite{}.
    %
    More recent trends in AI have made progress on task-based learning \cite{}, however, as we found in
    this work, random sampling tends to still be the most accurate manner by which to attain
    accurate results during exploratory data analysis.
    ...
    \subsubsection{Results and Challenges with this Analysis}
    ...
    a local police department, a service tech, or gas station owners.
    ...
    %
    The reference documents stored at \url{url1} and \url{url2} demonstrate this lack of linear
    seperability.
    %
    ...
    \subsection{Addressing Analysis Errors}
    ...
    \subsection{The Design of Bluetana}
    ...
    There is still an open problem in document \texttt{search}. 
    %
    We have seen in this analysis how flawed phrase-based analysis can be for the classification
    and understanding of data sets.
    %
    This calls into question the practice of using traditional search engines for the gethering of
    information on particular subjects.
    %
    It is entirely possible that a person's determination of which search phrases to use can bias 
    the results they recieve. 
    %
    A potential avenue of HCI research would be to break the common use case of searching for particular
    phrases, instead showing results that are deemed to be most useful.
    %
    Google is already doing this \cite{}.
