...
(POS) system~\cite{}. Prior work have developed mechanisms for the detection of external magnetic stripe 
based skimmers, which collect sensitive information by adding a second magnetic read head to the front
of the existing magnetic read head of a gas pump, ATM, or other payment terminal~\cite{}. However, no work 
...
whereby data is exfiltrated through the use of a wireless module and collected by connecting into wires responsible
for the transmission of sensitive card information~\cite{}. This thesis provides both a survey of current skimmer 
...
fifty skimming devices. Each skimmer makes around \$15,000 per day,\footnote{The typical card can be frauded 
for \$500, and the typical skimmer captures 30 cards per day.} indicating this research has prevented hundreds of 
thousands to millions of dollars in fraudulent charges. 
...
sale terminals has driven a proliferation of the market, with 972 devices recovered from Florida and 148 in Arizona in 2018~\cite{}.
...
either, often taking around thirty minutes to complete with a success rate below 4\%. Hence, there is an \emph{issue of skimming} 
which should be addressed, as it is funding a multi-million dollar economy on the backs of legitimate transactions, leading to 
market inefficiencies~\cite{}. The hypothesis of this thesis and related work is that the nature of internal skimmer 
installation makes data exfiltration necessary, therefore creating methods of detection. 
...
Bluetooth is then used by a ``mule'', or hired hand, to connect and collect stolen card information from the device~\cite{}.
This observation motivates the design and implementation of an application which uses features of Bluetooth for the detection
of skimmers, hence the development of Bluetana. The efficacy of this application can serve as a starting point for continued
research in the area of physical card fraud. This thesis therefore represents a ``case study'' which lends itself to more
general conclusions and a detailed understanding of the problem space.
...
read head that many skimmers of this type leverage \cite{}. Additionally, some pump manufacturers are advertising alarm systems which
alert the owner and law enforcement when pump doors are opened \cite{}. Several applications for the detection of Bluetooth based
...
and have been shown to be ineffective \cite{}. Skimmers using other wireless technologies, such as GSM, have also been found \cite{}, but
discussions with law enforcement have indicated that these devices are much less common than Bluetooth technologies, and an extensive
...
impact of discovering over fifty skimming devices and preventing hundreds of thousands to millions of dollars in fraud. The application
...
Skimming detection remains an open and important problem, and is the source of millions of dollars worth of fraud each year \cite{}. This
work describes current methods of detection and proposes a novel space of exploration. The lessons contained herein can provide motivation
for the next wave of research into the prevention and detection of these devices, ideally low cost, persistent wireless traffic monitors
...
improvement over traditional physical inspection, and, along with other tools such as SkimReaper \cite{}, can provide the first line of defense
