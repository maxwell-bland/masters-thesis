...
After all, in some sense, we have a program for solving 
\footnote{One's definition of solve could vary.} the halting problem: the programmer.
Humans can also drive cars without years of engineering effort.
However, approximating the mind is not the only option.
It may be possible to build automated systems for doing the analysis presented in this paper.
Frameworks for automated analysis of heterogeneous data may be a crucial next step.
