...
\footnote{A set of bytes used to say what a device is (phone, stereo, etc.).}
and uncustomized MAC addresses.
These features alone were effective in finding skimmers
(Figure~\ref{plot-of-class-and-MAC-filtered}).
...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{plots/plot-of-class-and-MAC-filtered.png}
  \caption{
...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{plots/flagging-flowchart.png}
  \caption{
...
Additionally, persistent monitoring devices could be deployed check radio traffic for payment information.
